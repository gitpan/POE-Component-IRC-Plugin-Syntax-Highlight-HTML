...
(it defaults to C<irc_html_highlighter>) will recieve input
...
If an error occured during the retrieval of HTML code then the C<error> key will be present
...
Please report any bugs or feature requests to C<bug-poe-component-irc-plugin-syntax-highlight-html at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-IRC-Plugin-Syntax-Highlight-HTML>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-IRC-Plugin-Syntax-Highlight-HTML>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-IRC-Plugin-Syntax-Highlight-HTML>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-IRC-Plugin-Syntax-Highlight-HTML>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-IRC-Plugin-Syntax-Highlight-HTML>
